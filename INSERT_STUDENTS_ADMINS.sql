-- IT Tech Arena AI - Insert Students and Admins
-- Run this in Supabase SQL Editor: Dashboard > SQL Editor > New Query

-- First, let's disable RLS temporarily for inserts (re-enable at the end)
...
-- Insert All Students from II Year Batch 2024-28 (68 Students Total)
INSERT INTO public.students (id, reg_no, name, role, login_time, is_online, technical_score, aptitude_score, overall_score, total_time, created_at)
VALUES 
...
-- Summary: Should show 2 admins + 68 students = 70 total
